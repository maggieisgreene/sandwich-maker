...
const breads = [
    {id: 'bread1', name: 'Italian', price : 300},
    {id: 'bread2', name: 'Whole Wheat', price : 300},
    {id: 'bread3', name: 'Italian Herbs & Cheese', price : 350},
    {id: 'bread4', name: 'Honey Oat', price : 350},
    {id: 'bread5', name: 'Gluten-Free', price : 400}
];
